...
function ProfileShopById() {
    ...
    const getData = async () => {
        ...
        var url = id ? `${api.GET_USER_DETAIL}?shopId=${id}` : `${api.GET_USER_DETAIL}`;
        await axios.get(url)
        .then(res => {
            if(res.data.success) {
    ...
    const getListImage = async () => {
        //lấy danh sách ảnh
        var url = id ? `${api.GET_LIST_IMAGE}?shopId=${id}` : api.GET_LIST_IMAGE
        await axios.get(url)
        .then(res => {
            if(res.data.success) {
    ...
    const getListProduct = async () => {
        //lấy danh sách ảnh
        var url = id ? `${api.GET_ALL_PRODUCT}?shopId=${id}` : api.GET_ALL_PRODUCT
        await axios.get(url)
        .then(res => {
            if(res.data.success) {
...
export default ProfileShopById;